...
public class TwoFightersTest {
    ...
    public void randomTests() {
        ...
        for (int i = 0; i < 200; i++) {
            ...
            assertEquals(solution(new Fighter(name[0], health[0], damagePerAttack[0]), new Fighter(name[1], health[1], damagePerAttack[1]), first), TwoFighters.declareWinner(new Fighter(name[0], health[0], damagePerAttack[0]), new Fighter(name[1], health[1], damagePerAttack[1]), first));
        }
    }
